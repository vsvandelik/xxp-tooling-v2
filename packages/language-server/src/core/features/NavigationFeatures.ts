...
export class NavigationFeatures {
    ...
    public async findDefinition(document: Document, position: TokenPosition): Promise<Location | null> {
    ...
    public async findReferences(document: Document, position: TokenPosition, includeDeclaration: boolean = false): Promise<Location[]> {
    ...
    public async findImplementations(document: Document, position: TokenPosition): Promise<Location[]> {
