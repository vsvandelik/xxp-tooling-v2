...
export default {
  displayName: '@extremexp/experiment-runner-server',
  ...
  moduleNameMapper: {
    ...
    '^@extremexp/experiment-runner-server$': '<rootDir>/src/server.ts',
    '^@extremexp/experiment-runner-server/(.*)$': '<rootDir>/src/$1',
